#!/usr/bin/python3
""" Checks for the Filestorage class """
import unittest
from os import path
...
class test_storage(unittest.TestCase):
    ...
    def test_no_objs(self):
        """ checks for empty class  """
        self.assertEqual(storage.all(), {})

    def test_all(self):
        """ checks for all method """
        storage = FileStorage()
        obj = storage.all()
